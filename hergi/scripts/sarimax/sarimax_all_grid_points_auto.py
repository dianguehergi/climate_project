...
SARIMA_RESULTS = PROJECT_ROOT / "results_sarima/all_grid_points/sarima_all_points_results_with_latlon.csv"
OUT_DIR = PROJECT_ROOT / "results_sarima/sarimax_all_points_auto"
...
def main():
    ...
    print("\nFichiers générés :")
    print("- results_sarima/sarimax_all_points_auto/sarimax_best_results_by_point.csv")
    print("- results_sarima/sarimax_all_points_auto/sarimax_full_grid_search_results.csv")
