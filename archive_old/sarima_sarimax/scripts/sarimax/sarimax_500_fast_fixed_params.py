...
SARIMA_POINTS_FILE = PROJECT_ROOT / "archive_old/sarima_sarimax_results/all_grid_points/sarima_all_points_results_with_latlon.csv"
OUT_DIR = PROJECT_ROOT / "archive_old/sarima_sarimax_results/sarimax_500_fast"
