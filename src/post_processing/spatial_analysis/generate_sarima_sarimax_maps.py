...
def main():
    ...
    p_sarima  = os.path.expanduser('~/climate_project/results/statistical/predictions_2000_2025/sarima_monthly_predictions_2000_2025_adamont.csv.gz')
    p_sarimax = os.path.expanduser('~/climate_project/results/statistical/sarimax_predictions_2000_2025/sarimax_monthly_predictions_2000_2025_adamont.csv.gz')
