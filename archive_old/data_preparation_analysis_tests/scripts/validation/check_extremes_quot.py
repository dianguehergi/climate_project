...
print("--- ANALYSE DES TEMPÉRATURES EXTRÊMES - QUOTIDIEN ---")
...
print("Recherche des valeurs extrêmes (< -10°C) sur toute la base...")
...
if len(df_extremes) > 0:
    ...
    output_csv = "data/processed/anomalies_quotidiennes.csv"
