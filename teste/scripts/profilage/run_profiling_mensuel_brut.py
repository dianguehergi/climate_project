...
print("--- Data Profiling : Mensuel BRUT (Mode Minimal) ---")

data_path = "data/interim/safran_mens_brut.csv"

if not os.path.exists(data_path):
    print(f"Erreur : Le fichier brut {data_path} n'existe pas. Lance d'abord merge_mensuel.py.")
    exit()

print("Chargement de la base mensuelle brute...")
...
output_html = "data/interim/profiling_mensuel_brut_report.html"
print(f"Sauvegarde du rapport brut dans {output_html}...")
profile.to_file(output_html)

print("--- Profiling Mensuel Brut terminé ! ---")
