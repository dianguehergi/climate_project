...
MONTHLY_FILE = PROJECT_ROOT / "results_sarima/all_grid_points/monthly_grid_temperature.csv"
COMPARISON_FILE = PROJECT_ROOT / "results_sarima/results_summary.csv"
OUTPUT_DIR = PROJECT_ROOT / "results_sarima/all_9892_best_model"
