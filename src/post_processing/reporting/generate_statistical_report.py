...
def appendix(pdf, page):
    ...
    groups = [
        ("Scripts HERGI", [
            "src/models/statistical/predict_sarima_2000_2025.py",
            "deprecated/sarima_sarimax/scripts/arima_sarima/generate_prediction_2000_2025_report.py",
            "src/models/statistical/predict_sarimax_2000_2025.py",
        ]),
        ("Prévisions SARIMA", [
            "results/statistical/predictions_2000_2025/temperature_predictions_2000_2025.csv.gz",
            "results/statistical/predictions_2000_2025/sarima_parameters_1960_1999.csv",
        ]),
        ("Prévisions SARIMAX", [
            "results/statistical/sarimax_predictions_2000_2025/temperature_predictions_2000_2025.csv.gz",
            "results/statistical/sarimax_predictions_2000_2025/etp_swi_predictions_2000_2025.csv.gz",
            "results/statistical/sarimax_predictions_2000_2025/sarimax_parameters_1970_1999.csv",
        ]),
        ("Rapports et contrôles", [
            "results/statistical/predictions_2000_2025/report/",
            "results/statistical/*/evaluation_summary.json",
            "results/statistical/*/validation_summary.json",
        ]),
    ]
